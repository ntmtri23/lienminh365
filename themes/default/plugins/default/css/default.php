...
.ossn-header {
background:#756a25 url('<?php echo ossn_theme_url(); ?>images/header-background.png') repeat-x;
height:90px;
}
.logo-second {
background:url('<?php echo ossn_theme_url(); ?>images/logo_lienminh365.png') no-repeat;
height:28px;
width:28px;
}
.ossn-header .inner{
...
.ossn-logo {
background:url('<?php echo ossn_theme_url(); ?>images/logo_lm365.png') no-repeat;
height: 49px;
width: 166px;
